...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Jefferson Marinho", "jeffersonmarinho97@gmail.com", new DateTime(1997, 6, 16), 1500.0, d2);
            Seller s3 = new Seller(3, "Paola Reis", "paolaemily@ymail.com", new DateTime(2000, 7, 10), 1000.0, d1);
            Seller s4 = new Seller(4, "Andreza Serra", "acbserra@gmail.com", new DateTime(1999, 2, 9), 1000.0, d3);
            Seller s5 = new Seller(5, "Marcelo Correa", "marcelocp15@gmail.com", new DateTime(1999, 5, 15), 1200.0, d4);
            Seller s6 = new Seller(6, "Carlos Lopes", "cadu@gmail.com", new DateTime(1999, 7, 25), 1000.0, d3);
